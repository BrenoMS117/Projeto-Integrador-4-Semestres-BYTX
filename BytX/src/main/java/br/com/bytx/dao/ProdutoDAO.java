...
public class ProdutoDAO {
    ...
    public void criarTabelaProdutos() {
        ...
        // NÃO CHAMAR produtoDAO.criarTabelaProdutos() aqui!
    }
    ...
    public List<Produto> buscarPorNome(String nome) {
        List<Produto> produtos = new ArrayList<>();
        String SQL = "SELECT * FROM produtos WHERE LOWER(nome) LIKE LOWER(?) ORDER BY data_criacao DESC";
    ...
    // Método para inicializar dados de teste (opcional)
    public void inserirDadosIniciais() {
        ...
        try {
            ...
            produto1.setPreco(new java.math.BigDecimal("3999.99"));
            produto1.setQuantidadeEstoque(50);
            produto1.setAvaliacao(new java.math.BigDecimal("4.5"));
            ...
            produto2.setPreco(new java.math.BigDecimal("3299.00"));
            produto2.setQuantidadeEstoque(25);
            produto2.setAvaliacao(new java.math.BigDecimal("4.2"));
            ...
            produto3.setPreco(new java.math.BigDecimal("1499.90"));
            produto3.setQuantidadeEstoque(100);
            produto3.setAvaliacao(new java.math.BigDecimal("4.8"));
            produto3.setAtivo(false); // Produto inativo para teste
            inserir(produto3);
